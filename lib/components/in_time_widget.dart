...
import 'in_time_model.dart';
export 'in_time_model.dart';

class InTimeWidget extends StatefulWidget {
  const InTimeWidget({super.key});
...
class _InTimeWidgetState extends State<InTimeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InTimeModel());
  }
